        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            <div className="mb-1.5 flex items-center justify-between">
              <label htmlFor={passwordFieldId} className="block text-sm font-medium text-gray-700">
                {t('portal.password')}
              </label>
              {onForgotPassword && (
                <button
                  ...
                  className="text-xs font-semibold text-brand-600 hover:underline focus:outline-none"
                >
                  {t('portal.forgotPassword', { defaultValue: 'Forgot Password?' })}
                </button>
              )}
            </div>
